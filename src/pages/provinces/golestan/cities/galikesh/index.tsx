...
export default function () {
  const city = Provinces["IR-24"].cities["IR-2410"]
  const menu = {
     ...
     <div className="w-full">
      <CityContent menu={menu} city={city}>
        <Section id="introduction" title="آشنایی با شهرستان">
          <p>
            شهرستان گالیکش یکی از شهرستان‌های استان گلستان واقع در شمال ایران
            است. این شهرستان از شمـال به کلاله ، از جنـوب به مینودشت و استان
            سمنان ، از شـرق به استان خراسان شمالی و از غـرب به شهرستان
            گنبدکـاووس محدود می شود.
          </p>
          <p>
            آب و هوای این شهرستان با توجه به ناهمورایها به دو نوع تقسیم می شود
            در ارتفاعات به علت کوهستانی بودن ، آب و هوای معتدل کوهستانی است، و
            در نواحی کم ارتفاع و جلگه ای به آب و هوای معتدل و نیمه مرطوب تبدیل
            می شود.
          </p>
          <p>
            جمعیت شهرستان گالیکش طبق سرشماری عمومی نفوس و مسکن در سال ۱۳۹5،
            برابر با 63 هزار و 173 نفر بوده‌است. شکل زیر موقعیت شهرستان گالیکش
            را نشان می دهد.
          </p>
        </Section>
        ...
        <Section id="services" title="خدمات" size="h3">
          <p>
            ...
            سودآوری بسیاری همراه است و در شهرستان گالیکش نیز ظرفیت های بسیار
            خوبی برای سرمایه گذاری در زمینه گردشگری وجود دارد.
          </p>
          <p>
            ییلاق پاکندس، آبشار لوه، غار کیارام، قلعه بی بی حلیمه، آبشار و چشمه
            پیرغار، چشمه لال، دشت شقایق و ... از جمله مناطق دیدنی شهرستان گالیکش
            هستند که هر ساله بازدید کنندگان زیادی دارند؛ بنابراین پتانسیل سرمایه
            گذاری در زمینه احداث هتل و اقامتگاه، مهمانسرا، اقامتگاه بوم گردی و
            همچنین رستوران بومی در این مناطق فراهم است.
          </p>
          <p>
          ...
          <p>
            موقعیت شهرستان گالیکش به گونه ای است که در مسیر مسافران مشهد مقدس
            قرار دارد؛ بنابراین احداث مجتمع خدماتی رفاهی از جمله برنامه های
            راهبردی برای دستیابی به اهداف اقتصادی خواهد بود.
          </p>
          <p>
          ...
          <p>
            متاسفانه شهرستان گالیکش فاقد شهربازی و سینما است؛ بنابراین احداث این
        ...
        <Section id="agriculture" title="زراعت" size="h3">
          ...
          <p>
            ...
            دانه ای، افتابگردان روغنی و کنجد به صورت گسترده در برخی از نقاط
            شهرستان گالیکش وجود داشته و با توجه به اینکه با شرایط اقلیمی و
            اکولوژیکی شهرستان سازگار هستند، گزینه های مناسبی برای بهره وری بهتر
            از آب و خاک محسوب می‌شوند.{" "}
          </p>
          <p>
          ...
          <p>
            گندم از جمله محصولات عمده و استراتژیک این شهرستان است که تاکنون
            عملکرد خوبی داشته و با توجه به سازگاری با شرایط شهرستان، پتانسیل های
            سرمایه گذاری را دارد. گندم در بازه زمانی حدودا هشت ماهه به ثمر نشسته
            و به مرحله سود دهی می رسد و در دو نوع بهاره و پاییزه کشت می شود که
          ...
          <p>
            اقلیم شهرستان گالیکش یکی از مناسب‌ترین اقلیم‌ها برای پرورش گیاهان
            دارویی مانند به لیمو، چای سبز، گل گاو زبان، اسطوخودوس، و ... است .
          ...
          <p>
            زعفران نیز از جمله مواردی است که کشت آن به تازگی در میان مردم جا
            افتاده و با توجه به عملکرد خوبی که داشته، ظرفیت های افزایش سطح زیر
            کشت را دارد.
          </p>
          <p>
          ...
          <p>
            ...
            شهرستان، توسعه کشت حبوباتی مانند ماش و لوبیا، از جمله مواردی است که
            ارزش افزوده زیادی را به دنبال دارد.
          </p>
          <p>
            با توجه به اینکه کشت چغندرقند در حال حاضر در این شهرستان وجود دارد،
            توسعه سطح زیر کشت آن در صورت مدیریت منابع آبی، سودآور خواهد بود.
          </p>
        </Section>
        <Section id="livestock" title="دامداری" size="h3">
          <p>
            دامداری در شهرستان گالیکش بیشتر به صورت سنتی انجام می‌شود. هر چند
            دامداری صنعتی و نیمه صنعتی نیز وجود دارد. مردم این شهرستان در زمینه
            دام سبک بیشتر گوسفند نژاد بومی، افشاری، رومانوف و دورگ
            افشاری-رومانوف را پرورش می‌دهند. البته پرورش بز بومی نیز به صورت
            محدود در برخی از نقاط شهرستان وجود دارد. در زمینه دام سنگین نیز
            بیشتر گاو هلشتاین را پرورش می‌دهند. پرورش تمام موارد فوق با اقلیم
          ...
          <p>
            زنبورداری نیز از جمله مشاغلی است که در حال حاضر به صورت گسترده در
            شهرستان انجام می‌شود و به سبب اقلیم مناسب و عملکرد بالا، پتانسیل های
        ...
        <Section id="food_industry" title="صنایع غذایی" size="h3">
          ...
          <p>
            ...
            شهرستان گالیکش فاقد کارخانه آرد است و گندم به سایر مناطق فرستاده
            می‌شود؛ بنابراین ایجاد چنین واحدی از جمله نیاز های مبرم این منطقه
            است که توجیه اقتصادی دارد.{" "}
          </p>
          <p>
          ...
          <p>
            با توجه به اینکه کشت کلزا، سویا، افتابگردان و کنجد در این شهرستان
            مورد توجه قرار گرفته و استقبال خوبی از آن می‌شود، روغن کشی از این
            موارد از جمله کسب و کار های پر بازدهی است که پتانسیل های ارزآوری را
            دارد.{" "}
          </p>
          <p>
          ...
          <p>
            ...
            تولید گیاهان دارویی در شهرستان گالیکش و نیز سهولت صادرات این محصولات
          ...
          <p>
            ...
            وجود مواد اولیه آنها در شهرستان گالیکش ، توجیه اقتصادی دارد.
          </p>
          <p>
            شهرستان گالیکش یکی از شهرستان هایی است که باغداری در آن عملکرد خوبی
        ...
        <Section id="undefined" title="صنایع تبدیلی" size="h3">
          ...
          <p>
            ...
            چنین واحدی در شهرستان فعال هستند؛ اما نیاز به این واحد همچنان وجود
            دارد. مراتع مهمترین بخش از منابع تجدید شونده است که به دلیل پایین
            ...
            دامپروری و پایین بودن ظرفیت تولیدی مراتع، این فشار بیشتر و بیشتر
            ...
            خوراک دام تولید شود، هم غذای مورد نیاز در این زمینه تأمین می شود و
          ...
          <p>
            ...
            بندی صنعتی رسیده است؛ اما شهرستان گالیکش فاقد چنین صنعتی است و عسل
            تولیدی به صورت فله ای به فروش می‌رسد .{" "}
          </p>
          <p>
          ...
          <p>
            ...
            به موارد گفته شده و تولید غلات در این شهرستان، بسته بندی غلات توجیه
            اقتصادی دارد. لازم به ذکر است که در صورت کافی نبودن مواد تولیدی،
          ...
          <p>
            با توجه به اینکه شهرستان گالیکش فاقد کشتارگاه صنعتی دام است و دام
            های شهرستان برای کشتار به گنبد فرستاده می‌شوند، ایجاد چنین واحدهایی
            از جمله نیاز های این شهرستان است که در صورت استقبال مردم قابلیت های
            سرمایه گذرای را خواهد داشت .
          </p>
          <p>
        ...
        <Section id="gardening" title="باغداری" size="h3">
          <p>
            باغداری یکی از حوزه‌های رایج در شهرستان گالیکش است. تولید اشتغال
          ...
          <p>
            زیتون از جمله محصولات باغی این شهرستان است که به مقدار زیاد و با
            کیفیت بالایی تولید می‌شود؛ بنابراین توسعه کاشت این محصولات که
          ...
          <p>
            ...
            تولید شده و ظرفیت های توسعه و ارز اوری را دارند.
          </p>
          <p>
          ...
          <p>
            ...
            گوجه را پرورش می‌دهند.{" "}
          </p>
          <p>
            با توجه به اینکه باغات برخی از میوه ها مانند هلو، آلو، شلیل و گلابی
          ...
          <p>
            احداث نهالستان برای تولید میوه نیز از دیگر مزیت های این شهرستان در
          ...
          <p>
            از دیگر پیشنهادات خوب حوزه باغداری، می‌توان به احداث باغات توت اشاره
            کرد که در حال حاضر به دلیل صنعت پرورش کرم ابریشم وجود داشته و محصول
            با کیفیتی را تولید می‌کنند.
          </p>
          <p>
            احداث باغ زرشک نیز با توجه به اینکه با اقلیم این منطقه سازگار است و
            به تازگی در این منطقه گسترش یافته است، قابل سرمایه گذاری بوده و
            ظرفیت های لازم برای توسعه را دارد. زرشک درخچه ای است که اعضای مختلف
            آن دارای خواص صنعتی و درمانی است؛ به علاوه به صورت تازه خوری هم مصرف
            می‌شود و در بین ایرانیان جایگاه ویژه ای دارد. زرشک گیاهی است که با
            کم آبی سازگار است؛ لذا با توجه به اینکه برخی از ذخایر آبی در کشور ما
            رو به پایان است، تولید و صادرات زرشک فرصت شغلی مناسبی برای سرمایه
            گذاری است.
          </p>
          <p>
        ...
        <Section id="birds" title="طیور" size="h3">
          ...
          <p>
            در شهرستان گالیکش چند مرغداری صنعتی وجود دارد که در زمینه پرورش مرغ
          ...
          <p>
            پرورش بلدرچین نیز از جمله کسب و کارهای زود بازده به شمار می‌شود و که
            شرایط آب و هوایی شهرستان سازگار است. بلدرچین پرنده ای با جثه کوچک،
            در برابر بسیاری از بیماری ها مقاوم است. پرورش بلدرچین به دلیل هزینه
          ...
          <p>
            پرورش بوقلمون، کبک، غاز و قرقاول و پرندگان زینتی مانند عروس هلندی از
            جمله مشاغلی هستند که در حال حاضر انجام می‌شوند و با توجه به سازگاری
            با اقلیم منطقه قابلیت توسعه و اجرا در سطح وسیع تر را دارند.
          </p>
          <p>
        ...
        <Section id="handicrafts" title="صنایع دستی" size="h3">
          ...
          <p>
            ابریشم بافی و چادر شب بافی نیز از جمله کسب و کار های رایج در شهرستان
            گالیکش است که قابلیت توسعه را دارد؛ زیرا مواد اولیه آنها در این
            شهرستان موجود است.
          </p>
          <p>
          ...
          <p>
            در ادامه می‌توان به مزیت هایی مانند سوزن دوزی، دوزندگی لباس محلی،
            نمدبافی و عروسک بافی اشاره کرد که در حال حاضر توسط برخی از مردم
        ...
        <Section id="fisheries" title="شیلات" size="h3">
          <p>
            ...
            چند استخر پرورش ماهی قزل آلا، سالمون، ماهی سفید و کپور وجود دارد،
        ...
        <Section id="industry" title="صنعت" size="h3">
          <p>
            ...
            گالیکش، تعدادی واحد صنعتی در زمینه های مختلف وجود دارد اما پتانسیل
          ...
          <p>
            ...
            سیمان، لبنیات، خوراک دام، ام دی اف، مبل و ... در داخل و خارج از شهرک
            صنعتی فعال هستند.
          </p>
        </Section>
      </CityContent>
