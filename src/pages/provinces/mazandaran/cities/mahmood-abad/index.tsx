...
export default function () {
  const city = Provinces["IR-27"].cities["IR-2718"]
  const menu = {
    ...
    <div>
      <CityContent menu={menu} advantage={city.advantage}>
        <Section id="introduction" title="آشنایی با شهرستان">
          <p>
            شهرستان محمودآباد یکی از شهرستان های استان مازندران است که از شمال
            به دریا، از شرق به فریدونکنار، از غرب به نور و از جنوب به آمل ختم
            می‌شود.
          </p>
          <p>
            جمعیت این شهرستان طبق سرشماری سال 1395، معادل با 98 هزار و 407 نفر
            بوده است. آب و هوای این شهرستان معتدل و مرطوب می باشد. شکل زیر
            موقعیت شهرستان محمود آباد را نشان می دهد.
          </p>
        </Section>
        ...
        <Section id="services" title="خدمات" size="h3">
          <p>
            ...
            سودآوری بسیاری همراه است و در شهرستان محمود آباد نیز ظرفیت های بسیار
            خوبی برای سرمایه گذاری در زمینه گردشگری وجود دارد.
          </p>
          <p>
            شهرستان محمودآباد یکی از زیباترین نواحی شمال ایران و استان مازندران
            است که در آن ساحل دریا به باریک‌‌ترین پهنای خود می‌رسد.که از نظر
            توسعه توریسم ساحلی از اهمیت بسیار بالایی برخوردار است. همچنین
            سقانفارهای عبدالله آباد و گلیرد، تپه‎ های باستانی سرخ‌رود، امامزاده
            قاسم، ساحل سرخ رود، تالاب سرخ رود، آبندان سرخ رود، جنگل روستای اهلم،
            جنگل بونده، پارک جنگلی طاهباز، پارک جنگلی تشبندان، روستای لاویج و
          ...
          <p>
            متاسفانه شهرستان سیمرغ دارای شهربازی و سینما با امکانات ضعیف است؛
        ...
        <Section id="agriculture" title="زراعت" size="h3">
          ...
          <p>
            اقلیم شهرستان محمود آباد یکی از مناسب‌ترین اقلیم‌ها برای پرورش
            گیاهان دارویی است . امروزه افراد زیادی به استفاده از گیاهان دارویی
        ...
        <Section id="gardening" title="باغداری" size="h3">
          <p>
            باغداری یکی از حوزه‌های رایج در شهرستان محمود آباد است. تولید اشتغال
          ...
          <p>
            میزان تولید مرکباتی مانند پرتقال، نارنج، نارنگی و ... در ای شهرستان
            زیاد است و باغداران این شهرستان سال‌ها است ازاین طریق درآمد زایی
            می‌کنند. با توجه به مرغوبیت و کیفیت بالای این محصولات و بازار خوبی
            که برای این تولیدات وجود دارد؛ سرمایه گذاری برای احداث این باغات از
            جمله چشم انداز های شهرستان برای دست یابی به اشتغال پایدار است.
          </p>
          <p>
        ...
        <Section id="livestock" title="دامداری" size="h3">
          <p>
            دامداری در شهرستان محمود آباد بیشتر به صورت سنتی انجام می‌شود. هر
            چند دامداری صنعتی و نیمه صنعتی نیز وجود دارد. مردم این شهرستان در
            زمینه دام سنگین نیز بیشتر گاو هلشتاین و گاو سمینتال را پرورش
            می‌دهند. در زمینه دام سبک بیشتر پرواربندی گوسفند انجام می‌شود. پرورش
            تمام موارد فوق با اقلیم شهرستان سازگار است و ظرفیت های توسعه را
            دارد. البته مردم بیشتر از دام سنگین استقبال می‌کنند؛ لذا پرورش دام
            سنگین در اولویت بهتری قرار می‌گیرد .
          </p>
          <p>
        ...
        <Section id="food_industry" title="صنایع غذایی" size="h3">
          ...
          <p>
            ...
            وجود مواد اولیه آنها در شهرستان محمودآباد ، توجیه اقتصادی دارد.
          </p>
        </Section>
        <Section id="birds" title="طیور" size="h3">
          <p>
            ...
            شهرستان محمود آباد چند مرغداری صنعتی وجود دارد که در زمینه پرورش مرغ
            گوشتی و مرغ مادر فعالیت می‌کنند. پرورش این موارد که با شرایط شهرستان
            سازگار هستند، تاکنون عملکرد خوبی داشته و پتانسیل های سرمایه گذاری را
            دارد.
          </p>
          <p>
          ...
          <p>
            پرورش اردک و بلدرچین نیز از جمله مشاغلی هستند که در حال حاضر به صورت
            سنتی انجام می‌شوند؛ اما با توجه به سازگاری با اقلیم منطقه قابلیت
        ...
        <Section id="handicrafts" title="صنایع دستی" size="h3">
          ...
          <p>
            در ادامه می‌توان به مزیت هایی حصیر بافی اشاره کرد که در حال حاضر
            توسط برخی از مردم شهرستان انجام شده و در صورت وجود بازار مصرف،
        ...
        <Section id="fisheries" title="شیلات" size="h3">
          <p>
            ...
            چند استخر پرورش ماهی کپور و قزل آلا وجود دارد ، کار کردن در این حوزه
        ...
        <Section id="industry" title="صنعت" size="h3">
          ...
          <p>
            ...
            پوشاک، ظروف یکبار مصرف، بلوک، پیچ و مهره، یونولیت، کاغذ، مصالح
            ساختمانی و ... در داخل و خارج از شهرک صنعتی فعال هستند.{" "}
          </p>
        </Section>
      </CityContent>
    </div>
