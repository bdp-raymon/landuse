...
export default function () {
  const city = Provinces["IR-27"].cities["IR-2704"]
  const menu = {
     ...
     <div className="w-full">
      <CityContent menu={menu} advantage={city.advantage}>
        <Section id="introduction" title="آشنایی با شهرستان">
          <p>
            شهرستان بهشهر یکی از شهرستان‌های استان مازندران است که از شمال به
            خلیجِ میانکاله، از شرق به شهرستانِ گلوگاه، از جنوب به دامنه‌های
            البرز و شهرستانِ دامغان و از غرب به شهرستانِ ساری و نکا محدود
            می‌شود. بهشهر به دلیلِ آب‌وهوای معتدل و بسیار مطبوعش، در طولِ تاریخ
            همواره موردِ توجّهِ گردشگران، دل‌باختگانِ طبیعت و شاهان و خوانینِ
            محلّی بوده‌است. طبق آخرین سرشماری جمعیت شهرستان بهشهر در سال ۱۳۹۵
            بالغ بر ۱۶۸ هزار و 769 نفر می‌باشد و پس از شهرستان‌های بابل، ساری،
            آمل و قائمشهر پرجمعیت‌ترین شهرستان این استان می‌باشد. شکل زیر موقعیت
            شهرستان بهشهر را نشان می‌دهد.
          </p>
        </Section>
        ...
        <Section id="gardening" title="باغداری" size="h3">
          <p>
            باغداری یکی از حوزه‌های رایج در شهرستان بهشهر است. تولید اشتغال توسط
          ...
          <p>
            مرکبات و میوه های دارای ریشه سیاه مانند هلو و همچنین انار، محصولات
            باغی استراتژیک شهرستان بهشهر هستند که با توجه به کیفیت بالا و امکان
            صادرات آنهاف قابلیت برای توسعه ی سطح زیر کشت آنها فراهم است.
          </p>
          <p>
          ...
          <p>
            ...
            جاتی مانند خیار و گوجه فرنگی را پرورش می‌دهند. گياهان براي داشتن رشد
            ...
            وجود پرورش گلخانه ای محصولات نیز نیاز به مراقبت های خاص خود را دارد.
          </p>
          <p>
            گردو نیز در این شهرستان طرفداران زیادی دارد و به مقدار بالایی کشت می
            شود. گردو، درختی چندساله و مقاوم است که پس از رشد کامل، هر درخت تا
          ...
          <p>
            توت فرنگی، شلیل و کیوی از دیگر محصولات باغی این شهرستان هستند که
            میتوان روی آنها سرمایه گذاری کرد.
          </p>
          <p>
          ...
          <p>
            خربزه و هندوانه نیز در شهرستان بهشهر در مقیاس بالایی کاشت می شوند و
            علاوه بر تامین نیاز شهرستان، به شهرهای اطراف نیز صادر می شوند. با
            توجه به اینکه کاشت محصولات جالیزی مانند خربزه و هندوانه به صورت دیمی
            و آبی در این شهرستان موفق بوده و با اقلیم و شرایط آب و هوایی سازگار
            است، توسعه و گسترش آنها از جمله کسب و کار های خوب در حوزه باغداری به
            شمار می‌رود که قابلیت سرمایه گذاری را دارد.
          </p>
          <p>
            در انتها باید گفت خرمالو یک محصول جدید در شهرستان است که کاشت آن
            موفقیت آمیز بوده است و پتانسیل بالایی برای سرمایه گذاری دارد.
          </p>
        </Section>
        <Section id="agriculture" title="زراعت" size="h3">
          ...
          <p>
            بهشهر نیز همانند دیگر شهرستان های نقاط شمالی کشور دارای مزارع وسیع
            برنج است که با توجه به آب و هوای مرطوب و مناسب آن قابلیت گسترش سطح
            زیر کشت وجود دارد.
          </p>
          <p>
          ...
          <p>
            گندم و جو، پس از برنج مهمترین محصولات زراعی شهرستان بهشهر محسوب می
            شوند که میتوان برای توسعه ی کشت این محصولات برنامه ریزی کرد.
          </p>
          <p>
          ...
          <p>
            اقلیم شهرستان بهشهر یکی از مناسب‌ترین اقلیم‌ها برای پرورش گیاهان
            دارویی مانند گل گاو زبان، آویشن، بادرنجبویه و ... است . امروزه افراد
          ...
          <p>
            ...
            کند. این گیاه، به راحتی پیوند می خورند و به سرعت در مناطق آفتابی که
          ...
          <p>
            کلزا و کنجد از انواع دانه های روغنی کشت شده در این شهرستان به شمار
            می روند که قابلیت سرمایه گذاری بروی کشت آنها وجوددارد. البته سطح زیر
            کشت کلزا بیشتر است؛ بنابراین در اولویت بالاتری نسبت به کنجد قرار می
            گیرد.
          </p>
          <p>
          ...
          <p>
            زعفران از محصولاتی است که به تازگی در شهرستان کشت شده است و با
            استقبال خوبی از سوی مردم مواجه شده است. و با توجه به موفقیت های حاصل
            شده در زمینه کشت آن میتوان گسترش کشت آن را پیشنهاد داد.
          </p>
          <p>
          ...
          <p>
            در نهایت می توان به حبوبات، توتون، باقلا، اسفناج و سویا بعنوان سایر
            محصصولات زراعی یاد کرد که امروزه در حد نیاز شهرستان کشت می شوند و
            میتوان برای گسترش فعالیت در این حوزه ها و صادرات آنها برنامه ریزی و
        ...
        <Section id="livestock" title="دامداری" size="h3">
          ...
          <p>
            پرورش دام سبک در شهرستان بهشهر بصورت سنتی و دام سنگین سنتی یا نیمه
            صنعتی صورت می گیرد. هم چنین 90 درصد دامداری ها، دام شیری پرورش می
            دهند. بنابراین زمینه برای احداث دامداری صنعتی و گوشتی در شهرستان
            فراهم است. دام های سنگین موجود در شهرستان از نژاد های بومی، هلشتاین،
            سمینتال و سوئیسی هستند و دام های سبک و گوسفندان از نژادهای بومی، زل
            و رومانف می باشند.
          </p>
          <p>
          ...
          <p>
            ...
            شود. در شهرستان بهشهر نیز پرورش گاو هلشتاین دورگ و سمینتال دورگ
          ...
          <p>زنبور داری نیز در شهرستان بهشهر رونق دارد و دارای مزیت می باشد.</p>
          <p>
          ...
          <p>
            لازم به ذکر است که پرورش گاومیش نیز بصورت خیلی پراکنده و محدود در
            شهرستان در حال انجام است و قابلیت توسعه دارد . گاومیش دامی است که
            ...
            کشاورزی و جلبک های موجود در آب هم تغذیه می‌کند. یکی از مهم‌ترین
        ...
        <Section id="birds" title="طیور" size="h3">
          ...
          <p>
            مرغداری های شهرستان بهشهر اکثرا گوشتی هستند. بنابراین احداث واحد
            پرورش مرغ تخمگذار و همچنین جوجه کشی از مزیت بالایی برخوردار است.
          </p>
          <p>
          ...
          <p>
            طبق بررسی های انجام شده، پرورش بلدرچین، قرقاول وکبک، یکی از کسب و
          ...
          <p>
            پرورش شترمرغ و بوقلمون نیز بصورت خانگی درحال انجام است و پتانسیل
            احداث واحد های صنعتی برای پرورش آنها در شهرستان وجود دارد.
          </p>
          <p>
        ...
        >
          ...
          <p>
            باتوجه به کشت میزان بالای برنج در شهرستان یکی از مشاغل پردرآمد
            بوجاری و بسته بندی برنج خواهد بود.{" "}
          </p>
          <p>
          ...
          <p>
            از آنجا دامداری در شهرستان بهشهر رونق دارد، مشاغل وابسته به دامداری
            مانند احداث کشتارگاه دام، احداث کارخانه خوراک دام و احداث واحد
            فرآوری پوست دام دارای پتانسیل برای سرمایه گذاری خواهند بود.
          </p>
          <p>
          ...
          <p>
            ...
            اشتغالزایی، سوددهی خوبی را به همراه خواهد داشت.{" "}
          </p>
          <p>
          ...
          <p>
            سردخانه در شهرستان بهشهر وجود دارد ولی بدلیل تولید فراوان میوه و
            غلات، همچنان زمینه برای احداث واحدهای دیگر وجود دارد.
          </p>
          <p>
          ...
          <p>
            زنبور داری در شهرستان بهشهر بسیار گسترش دارد. بطوریکه می توان احداث
            واحد بسته بندی عسل را پیشنهاد داد.
          </p>
          <p>
          ...
          <p>
            با توجه به کشت دانه های روغنی مانند کلزا و کنجد در شهرستان، میتوان
            برای احداث واحد روغن کشی از دانه های روغنی سرمایه گذاری کرد.
          </p>
          <p>
          ...
          <p>
            در نهایت برای سرمایه گذاری در این حوزه میتوان واحد های بسته بندی
            گوشت و همچنین فرآوری ماهی را پیشنهاد داد که درحال حاضر در شهرستان
            انجام می شوند و همچنان پتانسیل برای گسترش آنها وجود دارد.
          </p>
          <p>
          ...
          <p>
            ...
            وجود مواد اولیه آنها در شهرستان بهشهر ، توجیه اقتصادی دارد.
          </p>
          <p>
        ...
        <Section id="food_industry" title="صنایع غذایی" size="h3">
          ...
          <p>
            علیرغم اینکه انار، مرکبات و سایر میوه ها در این شهرستان به اندازه
            کافی تولید می‌شوند؛ اما واحدهایی در زمینه فراوری این محصولات در
            شهرستان وجود ندارد. با توجه به موقعیت شهرستان و گردشگرپذیربودن
            منطقه، راه‌اندازی کسب و کار فراوری محصولات باغی نامبرده شده مزیت
            دارد.
          </p>
          <p>
          ...
          <p>
            ...
            کمپوت و ... پتانسیل های لازم برای سرمایه گذاری را دارد.
          </p>
          <p>
          ...
          <p>
            ...
            از آب لیموی تازه است.{" "}
          </p>
          <p>
            کنسانتره پرتقال و لیموترش قابل استفاده در شیرینی پزی، محصولات پختنی،
            آبمیوه، نکتار، مربا و مارمالاد، دسر ها و شکلات ها هستند.
          </p>
          <p>
          ...
          <p>
            نظر بر اینکه کشت برخی از گیاهان دارویی در این شهرستان رونق گرفته،
            فراوری گیاهان دارویی از جمله پیشنهادات سودده این حوزه قلمداد می‌شود.
            ...
            گیاهان دارویی در شهرستان بهشهر و نیز سهولت صادرات این محصولات به
          ...
          <p>
            فرآوری گردو نیز یکی از مشاغل پیشنهادی این حوزه می باشد که با توجه به
            کشت بالای آن توجیه اقتصادی دارد.
          </p>
          <p>
          ...
          <p>
            دامداری در شهرستان بهشهر رونق بسیاری دارد ولی همچنان کارخانه ی
            لبنیات در این شهرستان احداث نشده است و فرآوری لبنیات بصورت خانگی
            درحال انجام است. بنابراین احداث چنین واحدی میتواند سودآوری خوبی به
            همراه داشته باشد.
          </p>
          <p>
        ...
        <Section id="fisheries" title="شیلات" size="h3">
          ...
          <p>
            فعالیت های این حوزه در شهرستان رونق نسبتا خوبی دارد و تعدادی واحد
            درخصوص پرورش ماهیان سردآبی و گرمابی احداث شده است و درحال فعالیت می
            باشند و با توجه به ظرفیت شهرستان، همچنان زمینه برای احداث واحد های
            جدید در خصوص پرورش این ماهی ها و همچنین ماهی های زینتی وجود دارد.
          </p>
          <p>
        ...
        <Section id="services" title="خدمات" size="h3">
          <p>
            ...
            سودآوری بسیاری همراه است و در شهرستان بهشهر نیز ظرفیت های بسیارخوبی
          ...
          <p>
            ...
            گردشگري از واقعيـت‌هـاي اجتنـاب ناپـذير اسـت.
          </p>
          <p>
            شهرستان بهشهر یکی از مناطق توریستی است که خیلی از مردم به دلیل
            زیبایی آن تمایل دارند به آن سفر کنند. همچنین به لحاظ فرهنگ و تمدن،
            آب و هوا و جاذبه های طبیعی سر آمد است. 40 اثر تاریخی در شهرستان به
            ثبت رسیده است که مهمترین آنان عبارتند از گورستان سفید چاه، کاخ صفی
            شاه، مجموعه چهل ستون، مجموعه عباس آباد، غار هوتو، آب انبارها و خانه
            ها تاریخی و روستای تاریخی رستم کلا، سواحل و جزیره میانکاله، آبشار و
            چشمه سنگ نو و ... که ماهانه میانگین بیش از 3 هزار نفر بازدید کننده
            دارند. بنابراین پتانسیل های سرمایه گذاری در زمینه گردشگری و
            راه‌اندازی مشاغلی مانند احداث رستوران بومی، اقامتگاه بومگردی و هتل و
            اقامتگاه را وجود دارد.
          </p>
          <p>
          ...
          <p>
            ...
            استقبال را در نظر بگیرید. راه جالبی برای پول درآوردن است.
          </p>
          <p>
            ...
            هدیای منحصر به فرد یا لباس‌‌‌‌‌‌های محلی و چیزهای دیگر به عنوان
        ...
        <Section id="industry" title="صنعت" size="h3">
          <p>
            ...
            بهشهر، تعدادی واحد صنعتی در زمینه های مختلف وجود دارد اما پتانسیل
            های شهرستان نشان دهنده این موضوع است که همچنان برای ایجاد واحدهای
            صنعتی جدید ظرفیت وجود دارد.
          </p>
          <p>
            شهرستان بهشهر دارای تعدادی معادن شن و ماسه گچ است که محصولات آنها
            خام فروشی میشوند. بنابراین می توان بروی واحد فرآوری این معادن سرمایه
            گذاری کرد. همچنین با توجه به گسترش ساخت و ساز احداث واحد تولید مصالح
            ساختمانی نیز دارای مزیت می باشد.
          </p>
          <p>
            تولید پروفیل آلومینیوم از دیگر مشاغل پیشنهادی این حوزه است که با
            سوددهی خوبی همراه خواهد بود.{" "}
          </p>
          <p>
            پروفیل آلومینیوم درصنایع مختلفی مانند صنعت ساختمانی بدلیل خواص
            پروفیل آلومینیوم موارد استفاده زیادی دارد. از مهم‌ترین فاکتورهایی
            پروفیل آلومینیوم که محرک استفاده آن در صنایع می شود، وزن کم، شکل
            پذیری بالا، مقاومت بالا در برابر زنگ زدگی، هزینه کم برای نگهداری،
            عمرطولانی و عدم‌نیاز به رنگ‌کردن می‌باشد. پروفیل آلومینیوم یکی از
            محصولات خروجی از فرآیند اکستروژن آلومینیوم می‌باشد که در اندازه و
            سطح مقطع‌های مخلتفی به بازار عرضه می‌شود که با در نظر گرفتن
            کاربردهای گوناگون این پروفیل‌ها و نیاز به خواص متفاوت، سطح آن نیز با
            مواد مختلفی پوشانده می‌شود.روند افزایش و میزان مصرف پروفیل آلومینوم
            باعث شده تا میزان تولید داخلی کفاف تقاضای پروفیل آلومینیوم را ندهد و
            در واقع دوسوم مصرف فعلی بازار در ایران از واردات تامین می شود.
          </p>
          <p>
            کابینت سازی و مبلمان سازی نیز در شهرستان درحال انجام اند و با توجه
            به بازار فروش مناسب، همچنان قابلیت توسعه و سرمایه گذاری دارند.
          </p>
          <p>
          ...
          <p>
            شهرستان بهشهر یک شهرک صنعتی دارد و واحدهای صنعتی فعال این شهرستان
            عبارتند از: کارگاه ریسندگی و بافندگی، کارخانه تولید نئوپان، کارخانه
            روغن گیری، کارخانه کاغذ سازی، کشتارگاه طیور و بسته بندی مرغ، کارگاه
            لبنیاتی، کارخانه تولید دستمال کاغذی، کارخانه سویا سازی، کارخانه
            تولید ادوات کشاورزی، کارخانه تن ماهی سازی، کارخانه تولید سبد میوه و
            ...
          </p>
        </Section>
        <Section id="handicrafts" title="صنایع دستی" size="h3">
          ...
          <p>
            صنایع دستی شهرستان بهشهر شامل قالیبافی و تابلو فرش، مصنوعات چرمی،
            سفالگری، گلیم بافی، زیورآلات و به میزان کمی منبت کاری می شود که
            قابلیت سرمایه گذاری و احداث کارگاه برای هر کدام از موارد ذکر شده
            وجود دارد.
          </p>
          <p>
