...
export default function () {
  const city = Provinces["IR-17"].cities["IR-1726"]
  const menu = {
     ...
     <div className="w-full">
      <CityContent menu={menu} city={city}>
        <Section id="introduction" title="آشنایی با شهرستان">
          <p>
            شهرستان مرودشت یکی از شهرستان‌های استان فارس ایران است که مرکز این
            شهرستان، شهر مرودشت است.شهرستان مرودشت در شمال شیراز واقع شده و آب و
            هوای آن در نواحی کوهستانی سردسیر و در سایرنواحی معتدل است. شهرستان
            مرودشت از شمال با شهرستان های اقلید و سپیدان، از جنوب با شهرستان های
            ارسنجان و خرامه و شیراز، از شرق با شهرستان های پاسارگاد و ارسنجان،
            از غرب با شهرستان های سپیدان و شیراز هم مرز است.جمعیت این شهرستان
            طبق سرشماری سال ۱۳۹۵، برابر با ۳۲۳٬۴۳۴ نفر بوده‌است. شکل زیر موقعیت
            شهرستان مرودشت را نشان می دهد.
          </p>
        </Section>
        <Section id="analyze" title="تحلیل شهرستان">
          <p>
            ...
            مي‌شود. در ادامه تحليل شهرستان مرودشت ارائه‌شده‌است.
          </p>
        </Section>
        ...
        <Section id="food_industry" title="صنایع غذایی" size="h3">
          ...
          <p>
            ...
            اما واحدهایی در زمینه فراوری این محصول در شهرستان وجود ندارد. با
            توجه به موقعیت شهرستان و گردشگرپذیربودن منطقه، راه‌اندازی کسب و کار
            فراوری انگور مزیت دارد .
          </p>
          <p>
          ...
          <p>
            با توجه به اینکه کاشت صیفی جاتی مانند گوجه در این شهرستان به صورت
            گسترده انجام می‌شود، مزیت هایی مانند تولید رب و پودر گوجه، برنامه
            های خوبی برای سرمایه گذاری و درآمدزایی هستند. البته لازم به ذکر است
            در حال حاضر واحد هایی برای تولید رب گوجه فعالیت می‌کنند؛ اما این
            صنعت همچنان جای کار داشته و می‌توان در این زمینه فعالیت کرد.{" "}
          </p>
          <p>
          ...
          <p>
            شهرستان مرودشت یکی از شهرستان هایی است که باغداری در آن عملکرد خوبی
        ...
        <Section id="livestock" title="دامداری" size="h3">
          ...
          <p>
            دامداری در شهرستان مرودشت بیشتر به صورت سنتی انجام می‌شود. هر چند
            دامداری صنعتی و نیمه صنعتی نیز وجود دارد. مردم این شهرستان در زمینه
            دام سبک بیشتر گوسفند نژاد عراقی، قشقایی و افشاری را پرورش می‌دهند.
            البته پرورش بز بومی و بز ترکی نیز به صورت محدود در برخی از نقاط
            شهرستان وجود دارد. در زمینه دام سنگین نیز بیشتر گاو بومی و گاو
            هلشتاین را پرورش می‌دهند. پرورش تمام موارد فوق با اقلیم شهرستان
          ...
          <p>
            در انتها می‌توان به راه اندازی کسب و کار هایی مانند پرورش عقرب و
            زالو اشاره کرد که هم اکنون نیز انجام شده و ظرفیت های توسعه و سوددهی
            را دارد.
          </p>
          <p>
        ...
        <Section id="gardening" title="باغداری" size="h3">
          <p>
            باغداری یکی از حوزه‌های رایج در شهرستان مرودشت است. تولید اشتغال
          ...
          <p>
            ...
            قابل توجهی تولید شده و ظرفیت های توسعه و ارز اوری را دارند. البته
            میزان استقبال مردم از باغات گردو بیشتر است؛ لذا در اولویت بهتری قرار
            می‌گیرد. گردو، درختی چندساله و مقاوم است که پس از رشد کامل، هر درخت
            تا 18 کیلوگرم تولید محصول خواهد داشت. محصول نهایی قیمت بالایی دارد
          ...
          <p>
            ...
            گوجه، سبزیجات و گل و گیاه زینتی را پرورش می‌دهند. البته استقبال از
            گلخانه گل و گیاه زینتی و سبزیجات کمتر است؛ لذا در اولویت های بعدی
            قرار می‌گیرد. همچنین کاشت صیفی‌جات در فضای آزاد نیز به صورت انبوه
            انجام می‌شود و قابلیت توسعه را دارد.
          </p>
          <p>
            انگور و انار از جمله محصولات باغی این شهرستان هستند که با کیفیت
            بالایی تولید می‌شوند؛ بنابراین توسعه کاشت این محصولات که طرفداران
            زیادی دارند از جمله برنامه های راهبردی برای توسعه اقتصاد شهرستان
            است.
          </p>
          <p>
          ...
          <p>
            با توجه به اینکه باغات برخی از میوه ها مانند سیب، آلو، هلو و زردآلو
        ...
        <Section id="agriculture" title="زراعت" size="h3">
          ...
          <p>
            ...
            کنجد به صورت پراکنده در برخی از نقاط شهرستان مرودشت وجود داشته و با
            توجه به اینکه با شرایط اقلیمی و اکولوژیکی شهرستان سازگار هستند،
            گزینه های مناسبی برای بهره وری بهتر از آب و خاک محسوب می‌شوند. البته
            میزان استقبال مردم از کشت کلزا بیشتر است؛ لذا در الویت بهتری قرار
            می‌گیرد.
          </p>
          <p>
          ...
          <p>
            با توجه به اینکه کشت برخی از گیاهان علوفه ای مانند ذرت علوفه ای در
            این شهرستان انجام شده و با موفقیت همراه بوده است، افزایش سطح زیر کشت
            آن‌ فرصت مناسبی برای سرمایه گذاری می‌باشد. ذرت علوفه‌ای دارای
            ویژگی‌هایی چون سازگاری با شرایط اقلیمی گرم و خشک و عملکرد بالا است.
            با کشت ذرت علوفه ای می‌توان نیاز کشاورزان را در تولید خوراک دام
          ...
          <p>
            با توجه به اینکه کشت سیب زمینی و پیاز در حال حاضر در این شهرستان
            وجود دارد، توسعه سطح زیر کشت این موارد در صورت مدیریت منابع آبی،
            سودآور خواهد بود.
          </p>
          <p>
            اقلیم شهرستان مرودشت یکی از مناسب‌ترین اقلیم‌ها برای پرورش گیاهان
            دارویی مانند پونه، آویشن، بابونه، مرزنجوش و ... است . امروزه افراد
        ...
        <Section id="birds" title="طیور" size="h3">
          <p>
            ...
            بوقلمون و شترمرغ از جمله مشاغلی هستند که در حال حاضر به صورت نیمه
            صنعتی و صنعتی انجام می‌شود و با توجه به سازگاری با اقلیم منطقه
          ...
          <p>
            در شهرستان مرودشت چند مرغداری صنعتی وجود دارد که در زمینه پرورش مرغ
          ...
          <p>
            ...
            لازم برای توسعه را دارند. محصولات کبک نسبت به دیگر طیور به دلیل طعم
          ...
          <p>
            پرورش پرندگان زینتی مانند نیز از جمله کسب و کار های این شهرستان است
            که در صورت تامین بازار مصرف همچنان جای کار داشته و قابلیت توسعه
            دارد. پرورش پرندگان زینتی به دلیل مزایایی از قبیل درآمدزایی بالا،
            ...
            در بین افراد جامعه پیدا کند. این قبیل از کسب‌وکارها به‌خوبی
            ...
            منطقه به سود دلخواه خود هم‌دست یابد.
          </p>
        </Section>
        <Section
        ...
        <Section id="handicrafts" title="صنایع دستی" size="h3">
          ...
          <p>
            گبه بافی و مجسمه سازی نیز از جمله پیشنهادات مناسب حوزه صنایع دستی
            است که با توجه به گردشگری بودن شهرستان، گزینه های مناسبی برای سوددهی
            به شمار می‌روند.
          </p>
          <p>
            بعد از موار فوق می‌توان به مزیت هایی دوزندگی لباس محلی، حصیر بافی و
            گل سازی اشاره کرد که در حال حاضر توسط برخی از مردم شهرستان انجام شده
            و در صورت وجود بازار مصرف، همچنان جای کار داشته و می‌توان این
        ...
        <Section id="industry" title="صنعت" size="h3">
          <p>
            ...
            مرودشت، تعدادی واحد صنعتی در زمینه های مختلف وجود دارد اما پتانسیل
            های شهرستان نشان دهنده این موضوع است که همچنان برای ایجاد واحدهای
            صنعتی جدید ظرفیت وجود دارد.
          </p>
          <p>
            در این شهرستان تعدادی معدن در زمینه تولید شن و ماسه، سنگ مرمر،
            گرانیت، و ... وجود دارد؛ اما متاسفانه برخی از این معادن فراوری
            نمی‌شوند و مواد استخراج شده به صورت خام به فروش می‌رسند؛ بنابراین
            ...
            درآمدهای اقتصادی شهرستان مرودشت و همچنین سرعت یافتن روند تولید و
          ...
          <p>
            با توجه به اینکه باغداری در وضعیت مطلوبی قرار دارد، تولید کارتن و
            سبد و همچنین ادوات کشاورزی که در حال حاضر از جمله واردات شهرستان
            هستند، پتانسیل های اشتغالزایی و ارزآوری را دارد.{" "}
          </p>
          <p>
            مشاغلی مانند تولید لوازم خانگی، قطعات خودرو، مواد شوینده و همچنین
          ...
          <p>
            ...
            قند، سیمان، مبل و ام دی اف، لوله پلی اتیلن، ظروف یکبارمصرف، پلاستیک
            سه لایه، خیارشور، ترشی، لبنیات، خوراک دام، آرد، بیسکوییت، کابینت و
            ... در داخل و خارج ازشهرک صنعتی فعال هستند.
          </p>
        </Section>
        <Section id="services" title="خدمات" size="h3">
          <p>
            ...
            سودآوری بسیاری همراه است و در شهرستان مرودشت نیز ظرفیت های بسیار
            خوبی برای سرمایه گذاری در زمینه گردشگری وجود دارد.
          </p>
          <p>
            تخت‌جمشید، نقش رستم‌، نقش رجب، شهر تاریخی اصتخر، تنگ‌ بستانک یا
            بهشت‌گمشده، پل خان، امامزاده ایوب مرودشت، روستای بند امیر و پل بند
            امیر، آبشار دشتک، سد درود زن، تفرجگاه تیرباغ، تنگ خشک، قصر قلات و
            ... از جمله مناطق دیدنی شهرستان مرودشت هستند که هر ساله بازدید
            کنندگان زیادی دارند؛ بنابراین پتانسیل سرمایه گذاری در زمینه احداث
            هتل و اقامتگاه، اقامتگاه بوم گردی و همچنین رستوران بومی در این مناطق
            فراهم است.
          </p>
          <p>
        ...
        <Section id="fisheries" title="شیلات" size="h3">
          ...
          <p>
            ...
            دارد. ماهی آمور که از خانواده ماهی های کپور هست ، شباهت زیادی به
            ماهی سفید خزر دارد به طوری که آن را سفید پرورشی می‌نامند. ماهی آمور
            به دلیل مرغوبیت گوشت ، امکان تکثیر مصنوعی ، رشد سریع و تغذیه با
            علوفه دستی از جمله ماهیان پرورشی صدرنشین محسوب می شود .
          </p>
        </Section>
      </CityContent>
    </div>
