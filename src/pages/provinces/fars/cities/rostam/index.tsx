...
export default function () {
  const city = Provinces["IR-17"].cities["IR-1712"]
  const menu = {
     ...
     <div className="w-full">
      <CityContent menu={menu} advantage={city.advantage}>
        <Section id="introduction" title="آشنایی با شهرستان">
          <p>
            شهرستان رستم یکی از شهرستان‌های استان فارس می‌باشد که در سمت شمال
            غربی این استان واقع شده‌است. مرکز این شهرستان شهر مصیری می‌باشد.این
            شهرستان از شمال به استان کهگیلویه و بویراحمد، از جنوب به شهرستان
            ممسنی ، از شرق به شهرستان ممسنی و استان کهگیلویه و بویر احمد و از
            غرب نیز به استان کهگیلویه و بویراحمد منتهی می‌گردد.شهرستان رستم از
            نظر آب و هوایی دارای سه نوع آب و هوای سرد و معتدل و گرم است.جمعیت
            این شهرستان طبق سرشماری سال 1395، معادل با ۴۴٬۳۸۶ نفر بوده است. شکل
            زیر موقعیت شهرستان رستم را نشان می دهد.
          </p>
        </Section>
        <Section id="analyze" title="تحلیل شهرستان">
          <p>
            ...
            مي‌شود. در ادامه تحليل شهرستان رستم ارائه‌شده‌است.
          </p>
        </Section>
        ...
        <Section id="livestock" title="دامداری" size="h3">
          <p>
            دامداری در شهرستان رستم بیشتر به صورت سنتی انجام می‌شود. هر چند
            دامداری صنعتی و نیمه صنعتی نیز وجود دارد. مردم این شهرستان در زمینه
            دام سبک بیشتر گوسفند نژاد بومی، قشقایی، بختیاری و افشاری را پرورش
            می‌دهند. البته پرورش بز بومی، بز دورگ پاکستانی و بز سانن نیز به صورت
            محدود در برخی از نقاط شهرستان وجود دارد. در زمینه دام سنگین نیز
            بیشتر گاو هلشتاین و جرسی دورگ را پرورش می‌دهند. پرورش تمام موارد فوق
          ...
          <p>
            ...
            شود. در شهرستان رستم نیز پرورش گاو هلشتاین دورگ و جرسی دورگ انجام
          ...
          <p>
            در انتها می‌توان به راه اندازی کسب و کار هایی مانند پرورش عقرب اشاره
        ...
        <Section id="food_industry" title="صنایع غذایی" size="h3">
          ...
          <p>
            ...
            شهرستان رستم فاقد کارخانه آرد است و گندم تولیدی بیشتر به کارخانه آرد
            شیراز و یاسوج فرستاده می‌شود؛ بنابراین ایجاد چنین واحدی از جمله نیاز
            های مبرم این منطقه است که توجیه اقتصادی دارد .{" "}
          </p>
          <p>
          ...
          <p>
            ...
            استقبال خوبی از آن می‌شود، روغن کشی از کلزا از جمله کسب و کار های پر
          ...
          <p>
            ...
            تولید گیاهان دارویی در شهرستان رستم و نیز سهولت صادرات این محصولات
          ...
          <p>
            در راستای تحقق اهداف اقتصادی احداث واحدی برای گلاب گیری دارای صرفه
            اقتصادی می باشد. اهمیت گل محمدی در تولید عطر، اسانس و گلاب آن است.
        ...
        >
          ...
          <p>
            ...
            بندی صنعتی رسیده است؛ اما شهرستان رستم فاقد چنین صنعتی است و عسل
          ...
          <p>
            ...
            که ضمن اشتغال‌زایی بستری مناسب برای عرضه محصولات باغی با نام خود
            شهرستان به بازار آماده می‌کند.
          </p>
          <p>
            علیرغم اینکه در این شهرستان محصولات باغی به خصوص مرکبات به میزان
            زیادی تولید می‌شوند، سردخانه های موجود کفاف نیاز شهرستان را نداده و
            نیاز به احداث چنین واحد هایی در صورت توسعه سطح زیر کشت این موارد حس
            می‌شود؛ بنابراین سرمایه گذاری در زمینه احداث سردخانه، سوددهی خوبی به
            همراه خواهد داشت . از مهمترین مزایای استفاده از سردخانه میوه و سبزی
          ...
          <p>
            با توجه به اینکه شهرستان رستم فاقد کشتارگاه صنعتی دام است، ایجاد
          ...
          <p>
            ...
            است و در حال حاضر خوراک دام از شیراز وارد می‌شود. مراتع مهمترین بخش
            ...
            آن وارد می شود. با توجه به افزیش دامپروری و پایین بودن ظرفیت تولیدی
            مراتع، این فشار بیشتر و بیشتر می‌شود و برای جلوگیری از تخریب مراتع
            باید به فکر منابع غذایی غیر مرتعی آن‌ها بود. با اجرای پروژه های
        ...
        <Section id="gardening" title="باغداری" size="h3">
          <p>
            باغداری یکی از حوزه‌های رایج در شهرستان رستم است. تولید اشتغال توسط
          ...
          <p>
            شهرستان رستم یکی از شهرستان های مستعد در تولید مرکباتی مانند پرتقال،
            لیمو، نارنگی و ... است؛ لذا توسعه باغات مرکبات همچنان جای کار داشته
          ...
          <p>
            ...
            گوجه و توت فرنگی را پرورش می‌دهند. البته استقبال از گلخانه توت فرنگی
            کمتر است؛ لذا در اولویت های بعدی قرار می‌گیرد. البته کاشت صیفی‌جات
            در فضای آزاد نیز انجام می‌شود و قابلیت توسعه را دارد.
          </p>
          <p>
            از دیگر پیشنهادات خوب حوزه باغداری، می‌توان به کاشت گل محمدی اشاره
        ...
        <Section id="agriculture" title="زراعت" size="h3">
          ...
          <p>
            ...
            کنجد به صورت پراکنده در برخی از نقاط شهرستان رستم وجود داشته و با
            ...
            کلزا سطح زیر کشت بیشتر دارد و اولویت بهتری را به خود اختصاص می‌دهد.
          </p>
          <p>
          ...
          <p>
            اقلیم شهرستان رستم یکی از مناسب‌ترین اقلیم‌ها برای پرورش گیاهان
            دارویی مانند گل گاو زبان، به لیمو و ... است . امروزه افراد زیادی به
        ...
        <Section id="handicrafts" title="صنایع دستی" size="h3">
          ...
          <p>
            ...
            مصرف، همچنان جای کار داشته و می‌توان این تولیدات را افزایش داد. گبه
            نوعی قالی گره بافته با بافت درشت است که دارای پرزهای بلند (بین 1 تا
            3 سانتی متر) است، کم بودن تعداد پود های گبه که بین 3 تا 8 عدد است
        ...
        <Section id="industry" title="صنعت" size="h3">
          ...
          <p>
            شهرستان رستم فاقد شهرک صنعتی است و کارخانه های یخ سازی، برنج کوبی و
            تولید ام دی اف، در سطح شهرستان فعال هستند .
          </p>
        </Section>
        <Section id="birds" title="طیور" size="h3">
          <p>
            ...
            بررسی های انجام شده، پرورش بوقلمون یکی از کسب و کار های پر سود در
          ...
          <p>
            در شهرستان رستم تعدادی مرغداری صنعتی وجود دارد که در زمینه پرورش مرغ
          ...
          <p>
            پرورش شترمرغ نیز در صورت وجود بازار مصرف، از جمله فرصت‌های مناسب
            سرمایه گذاری است؛ زیرا با اقلیم شهرستان سازگار بوده و تاکنون عملکرد
            خوبی داشته است.
          </p>
          <p>
        ...
        <Section id="fisheries" title="شیلات" size="h3">
          <p>
            ...
            می‌شود. در این زمینه تعداد زیادی استخر پرورش ماهی قزل وجود دارد که
            تاکنون عملکرد و بازار مصرف خوبی داشته اند و به سایر مناطق نیز
            فرستاده می‌شود؛ لذا کار کردن در این حوزه در صورت تامین منابع آبی
        ...
        <Section id="services" title="خدمات" size="h3">
          <p>
            ...
            سودآوری بسیاری همراه است و در شهرستان رستم نیز ظرفیت های بسیار خوبی
            برای سرمایه گذاری در زمینه گردشگری وجود دارد.
          </p>
          <p>
            چشمه انجیری، سراب سیاه منصورآباد، پتکون زیردو، سرچشمه گجستان، دلی
            زوال و دشتک، آبشار پای تف، کوه سیاه و ... از جمله مناطق دیدنی
            شهرستان رستم هستند که هر ساله بازدید کنندگان زیادی دارند؛ بنابراین
            پتانسیل سرمایه گذاری در زمینه احداث هتل و اقامتگاه، اقامتگاه بوم
            گردی و همچنین مجتمع تفریحی سرگرمی در این مناطق فراهم است.
          </p>
          <p>
          ...
          <p>
            متاسفانه شهرستان رستم فاقد شهربازی و سینما است؛ بنابراین احداث این
